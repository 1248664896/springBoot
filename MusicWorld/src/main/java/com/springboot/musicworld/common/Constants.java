package com.springboot.musicworld.common;
...
public class Constants {
    ...
    public final static String MUSIC_IMG_FILE_PATH = "D:\\musicWorld\\imgFile";

    public final static String path ="D:\\musicWorld\\newFile\\";

    public  final static  String Putaway = "putaway";//音乐上架

    public  final static  String UnShelve = "unShelve";//音乐下架

    public final static String filePathName =  "D:\\musicWorld\\sourceFile\\";
